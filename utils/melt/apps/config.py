...
flags.DEFINE_float('loss_decay', 0.9, '')
...
flags.DEFINE_float('clip_gradients', 5., """follow im2text as 5.0 default, 
...
flags.DEFINE_bool('log_all_folds', False, '')
...
flags.DEFINE_integer('max_metrics_show', 10, '')
...
flags.DEFINE_string('tqdm_colour', 'white', 'None as white, cyan, blue')
...
flags.DEFINE_integer('num_workers', 4, 'mainly for torch dataset')
flags.DEFINE_bool('pin_memory', True, '')
...
flags.DEFINE_string('kaggle_dataset_method', 'update', '')
flags.DEFINE_alias('kd_method', 'kaggle_dataset_method')
flags.DEFINE_alias('kdmethod', 'kaggle_dataset_method')
flags.DEFINE_alias('kmethod', 'kaggle_dataset_method')
...
flags.DEFINE_integer('kaggle_fold', 0, '')
